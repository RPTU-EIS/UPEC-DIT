...
set_compile_option -golden -black_box_instances {{P1/i_cache_subsystem} {P2/i_cache_subsystem} {P1/issue_stage_i/i_issue_read_operands/i_ariane_regfile} {P2/issue_stage_i/i_issue_read_operands/i_ariane_regfile} {P1/ex_stage_i/fpu_gen/fpu_i} {P2/ex_stage_i/fpu_gen/fpu_i}}

compile -golden

set_mode mv

read_sva -version {sv2012} {ariane_dit.sva}
